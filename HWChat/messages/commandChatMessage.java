...
public class commandChatMessage extends chatMessage
{
	...
	*/
	public static final int TOGGLE_SPELL_CHECKING_COMMAND = 14;
	/*  TOGGLE_SPELL_CHECKING
		sender - the person who sent the message
		message - Not Used
		channelName - Not Used
		Target - The user you want to make into a admin
		command type - /startSpellChecker [username]
	*/
	public static final int IGNORE_COMMAND = 15;
	/*  Ignore
		sender - the person who sent the message
		message - Not Used
		channelName - Not Used
		Target - The user you want to ignore
		command type - /ignore [username]
	*/
	public static final int SYSTEM_COMMAND = 16;
	/*  Ignore
		sender - the person who sent the message
		message - What to say
		channelName - channel it was said in
		Target - not used
		command type - /system [message]
	*/
	public static final int GET_ONLINE_LIST_COMMAND = 17;
